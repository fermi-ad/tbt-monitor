...
% Final corrected Best-1/3/5 values and selected examples are inserted here.
The corrected search reproduces the qualitative plane asymmetry seen in the exploratory run: adding a small number of adaptively chosen BPMs improves the vertical tune candidate more consistently than the horizontal candidate. The final manuscript will report only verifier-clean corrected rows, exact channel identities, paired effect estimates, and later-window validation intervals.
...
The legacy comparator uses identical tune bands and binning but came from a normalized single-channel selector whose winner was effectively determined by floating-point residuals after RMS normalization. It is therefore labeled ``legacy normalized-single'', not ``best BPM''. Paired panels use exact common spill/window ridge points and one color scale. Difference maps subtract column-normalized ridge-pick densities; they quantify redistribution and concentration of ridge picks, not physical noise removal. Moving-block intervals across turn centers test whether paired concentration changes persist despite the heavily overlapping windows; they are not uncertainty estimates over the spill population.
...
M. A. Ibrahim \textit{et al.}, ``Preliminary design of Mu2E Spill Regulation System (SRS)'', in \textit{Proc. IBIC'19}, Malmo, Sweden, Sep. 2019, pp.~177--180. \doi{10.18429/JACoW-IBIC2019-MOPP033}
...
N. Patel \textit{et al.}, ``Beam position monitoring system for Fermilab's Muon Campus'', in \textit{Proc. IBIC'19}, Malmo, Sweden, Sep. 2019, pp.~648--650. \doi{10.18429/JACoW-IBIC2019-WEPP044}

\bibitem{zisopoulos:ipac2017-mopab122}
P. Zisopoulos, M. Gasior, M. Serluca, and G. Sterbini, ``Fast bunch by bunch tune measurements at the CERN PS'', in \textit{Proc. IPAC'17}, Copenhagen, Denmark, May 2017, pp.~415--418. \doi{10.18429/JACoW-IPAC2017-MOPAB122}
