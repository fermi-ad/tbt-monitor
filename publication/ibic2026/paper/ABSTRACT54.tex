...
\IfFileExists{figures/best_n_validation_hv.pdf}{%
\begin{figure*}[!htb]
  \centering
  \includegraphics[width=0.98\textwidth]{figures/best_n_validation_hv.pdf}
...
\IfFileExists{figures/ridge_density_comparison.pdf}{%
\begin{figure*}[!htb]
  \centering
  \includegraphics[width=0.93\textwidth]{figures/ridge_density_comparison.pdf}
...
\IfFileExists{figures/ridge_width_contrast_hv.pdf}{%
\begin{figure*}[!htb]
  \centering
  \includegraphics[width=0.82\textwidth]{figures/ridge_width_contrast_hv.pdf}
