...
\begin{figure*}[!htb]
  ...
  \caption{Exact-paired adaptive-minus-legacy P10--P90 ridge-pick width for the selected horizontal and vertical ensembles. Negative values indicate a narrower adaptive cross-spill pick distribution at that turn center. Both panels use one y scale. Exported values are unsmoothed; the curves use five-window visual smoothing. The zero-referenced contrast describes probability redistribution, not physical noise removal or extraction timing.}
