...
Across 4,000 corrected spill-plane rows per subset size, the median adaptive-search score rises from 0.343 to 0.392 and 0.403 for horizontal Best-1, Best-3, and Best-5, and from 0.420 to 0.484 and 0.524 vertically. Paired Best-1-to-Best-3 gains are 0.0500 horizontally and 0.0646 vertically; Best-3-to-Best-5 gains are 0.0122 and 0.0310. These are in-sample model-selection scores, not tune-accuracy measurements. Leakage-controlled later-window results and exact-paired persistence metrics are reported in Table~\ref{tab:results}.
