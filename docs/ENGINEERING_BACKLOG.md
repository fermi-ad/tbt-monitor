...
- Validation: PYTHONPYCACHEPREFIX=/tmp/tbt-monitor-pycache python3 -m py_compile scripts/bpm_mining/*.py scripts/test_best_bpm_mining.py; python3 scripts/test_best_bpm_mining.py (6 tests); Spark smoke passed; full Spark run active at `/home/derekste/best_bpm_mining_20260624_full_v2`
