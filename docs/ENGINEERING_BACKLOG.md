...
- Notes: "all training" intentionally excludes held-out digitizers and is therefore not literal all-60 aggregation. It is the maximum fair baseline under the internal validation design. The result cannot establish external tune accuracy and cannot retroactively retune the Best-N gate.
